...
module.exports = {
    ...
    buscarPais(code){
        const pais = countries.find((country) => (code == country.iso2 || code == country.iso3));
        return pais.nombre
    },
    ...
    direccion(deg){
        if(deg < 22 ) return {dir:'Este', grados: deg}
        else if(deg < 67) return {dir:'Noreste', grados: deg}
        else if (deg < 112) return  {dir:'Norte', grados: deg}
        else if(deg < 157) return {dir: 'Noroeste', grados: deg}
        else if (deg < 202) return {dir:'Oeste', grados: deg}
        else if (deg < 247) return {dir:'Suroeste', grados: deg}
        else if (deg < 292) return {dir:'Sur', grados: deg}
        else if (deg < 337) return {dir:'Sureste', grados: deg}
        else if (deg <= 360) return {dir:'Este', grados: deg}
    }
